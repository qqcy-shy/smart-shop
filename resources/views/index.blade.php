...
<!-- //for bootstrap working -->
<!-- <link href="{{ URL::asset('http://fonts.useso.com/css?family=Montserrat:400,700') }}" rel='stylesheet' type='text/css'> -->
<!-- <link href="{{ URL::asset('http://fonts.useso.com/css?family=Lato:400,100,100italic,300,300italic,400italic,700,900,900italic,700italic') }}" rel='stylesheet' type='text/css'> -->
...
<div class="header">
	<div class="container">
		<ul>
			<li class='col-md-3'><span class="glyphicon glyphicon-time" aria-hidden="true"></span>{{ trans('index.fast') }}</li>
			<li class='col-md-3'><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>{{ trans('index.free') }}</li>
			<li class='col-md-3'>
				<a href="/zh_cn">中文</a> / 
				<a href="/en">English</a>
			</li>
...
<div class="header-bot">
	<div class="container">
		...
		<div class="col-md-6 header-middle">
			<form>
				<div class="search">
					<input type="search" value="{{ trans('index.search') }}" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search';}" required="">
				</div>
				<div class="section_room">
					<select id="country" onchange="change_country(this.value)" class="frm-field required">
						<option value="null">{{ trans('index.categories') }}</option>
						<option value="null">{{ trans('index.electronics') }}</option>     
						<option value="AX">{{ trans('index.kids') }}</option>
						<option value="AX">{{ trans('index.men') }}</option>
						<option value="AX">{{ trans('index.women') }}</option>
						<option value="AX">{{ trans('index.watches') }}</option>
					</select>
				</div>
				<div class="sear-sub">
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item menu__item--current"><a class="menu__link" href="index.html">{{ trans('index.home') }} <span class="sr-only">(current)</span></a></li>
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{ trans('index.men') }} <span class="caret"></span></a>
								...
								<div class="row">
									...
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="mens.html">{{ trans('index.clothing') }}</a></li>
											<li><a href="mens.html">{{ trans('index.wallets') }}</a></li>
											<li><a href="mens.html">{{ trans('index.footwear') }}</a></li>
											<li><a href="mens.html">{{ trans('index.watches') }}</a></li>
											<li><a href="mens.html">{{ trans('index.accessories') }}</a></li>
											<li><a href="mens.html">{{ trans('index.bags') }}</a></li>
											<li><a href="mens.html">{{ trans('index.cap') }}</a></li>
										</ul>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="mens.html">{{ trans('index.jewellery') }}</a></li>
											<li><a href="mens.html">{{ trans('index.sunglasses') }}</a></li>
											<li><a href="mens.html">{{ trans('index.perfumes') }}</a></li>
											<li><a href="mens.html">{{ trans('index.beauty') }}</a></li>
											<li><a href="mens.html">{{ trans('index.shirts') }}</a></li>
											<li><a href="mens.html">{{ trans('index.sunglasses') }}</a></li>
											<li><a href="mens.html">{{ trans('index.swimwear') }}</a></li>
										</ul>
									</div>
									<div class="clearfix"></div>
								</div>
					...
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{ trans('index.women') }} <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="womens.html">{{ trans('index.clothing') }}</a></li>
											<li><a href="womens.html">{{ trans('index.wallets') }}</a></li>
											<li><a href="womens.html">{{ trans('index.footwear') }}</a></li>
											<li><a href="womens.html">{{ trans('index.watches') }}</a></li>
											<li><a href="womens.html">{{ trans('index.accessories') }}</a></li>
											<li><a href="womens.html">{{ trans('index.bags') }}</a></li>
											<li><a href="womens.html">{{ trans('index.cap') }}</a></li>
										</ul>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="womens.html">{{ trans('index.jewellery') }}</a></li>
											<li><a href="womens.html">{{ trans('index.sunglasses') }}</a></li>
											<li><a href="womens.html">{{ trans('index.perfumes') }}</a></li>
											<li><a href="womens.html">{{ trans('index.beauty') }}</a></li>
											<li><a href="womens.html">{{ trans('index.shirts') }}</a></li>
											<li><a href="womens.html">{{ trans('index.sunglasses') }}</a></li>
											<li><a href="womens.html">{{ trans('index.swimwear') }}</a></li>
										</ul>
									</div>
					...
					<li class=" menu__item"><a class="menu__link" href="electronics.html">{{ trans('index.electronics') }}</a></li>
					<li class=" menu__item"><a class="menu__link" href="codes.html">{{ trans('index.short') }}</a></li>
					<li class=" menu__item"><a class="menu__link" href="contact.html">{{ trans('index.contact') }}</a></li>
				  </ul>
				</div>
			  </div>
			</nav>	
			...
			<div class="cart box_1">
				<a href="checkout.html">
					<h3> <div class="total">
						...
						<span class="simpleCart_total"></span> (<span id="simpleCart_quantity" class="simpleCart_quantity"></span> {{ trans('index.items') }})</div>
						
					</h3>
				</a>
				<p><a href="javascript:;" class="simpleCart_empty">{{ trans('index.empty cart') }}</a></p>						
			</div>	
		</div>
		<div class="clearfix"></div>
	</div>
...
<div class="footer">
	<div class="container">
		<div class="col-md-3 footer-left">
			...
			<p>{{ trans('index.Neque porro quisquam est, qui dolorem ipsum quia dolor
		...
		<div class="col-md-9 footer-right">
			<div class="col-sm-6 newsleft">
				<h3>{{ trans('index.SIGN UP FOR NEWSLETTER') }} !</h3>
			</div>
			<div class="col-sm-6 newsright">
				<form>
					<input type="text" value="{{ trans('index.Email') }}" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}" required="">
					<input type="submit" value="{{ trans('index.Submit') }}">
				</form>
			</div>
			<div class="clearfix"></div>
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					<h4>{{ trans('index.Information') }}</h4>
					<ul>
						<li><a href="index.html">{{ trans('index.Home') }}</a></li>
						<li><a href="mens.html">{{ trans("index.Men's Wear") }}</a></li>
						<li><a href="womens.html">{{ trans("index.Women's Wear") }}</a></li>
						<li><a href="electronics.html">{{ trans('index.Electronics') }}</a></li>
						<li><a href="codes.html">{{ trans('index.Short Codes') }}</a></li>
						<li><a href="contact.html">{{ trans('index.Contact') }}</a></li>
					</ul>
				</div>
				
				<div class="col-md-4 sign-gd-two">
					<h4>{{ trans('index.Store Information') }}</h4>
					<ul>
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>{{ trans('index.Address') }} : {{ trans('index.1234k Avenue, 4th block') }}</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>{{ trans('index.Email') }} : <a href="mailto:info@example.com">{{ trans("index.info@example.com") }}</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>{{ trans('index.Phone : +1234 567 567') }}</li>
					</ul>
				</div>
				<div class="col-md-4 sign-gd flickr-post">
					<h4>{{ trans('index.Flickr Posts') }}</h4>
					<ul>
